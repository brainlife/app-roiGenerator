...
do
	...
	for DEG in ${!minDegree[@]}; do
		...
		[ ! -f ./${hemi}.Ecc${minDegree[$DEG]}to${maxDegree[$DEG]}.func.gii ] && mri_binarize --i ./${hemi}.polarAngle.func.gii --min ${minDegree[$DEG]} --max ${maxDegree[$DEG]} --o ./${hemi}.polarAngle${minDegree[$DEG]}to${maxDegree[$DEG]}.func.gii && wb_command -metric-mask ./${hemi}.polarAngle${minDegree[$DEG]}to${maxDegree[$DEG]}.func.gii ./${hemi}.mask.func.gii ./${hemi}.polarAngle${minDegree[$DEG]}to${maxDegree[$DEG]}.func.gii

		# create volume-based binned file
		[ ! -f ./${hemi}.polarAngle${minDegree[$DEG]}to${maxDegree[$DEG]}.nii.gz ] && mri_surf2vol --o ./${hemi}.polarAngle${minDegree[$DEG]}to${maxDegree[$DEG]}.nii.gz --subject ./ --so ./${hemi}.pial ./${hemi}.polarAngle${minDegree[$DEG]}to${maxDegree[$DEG]}.func.gii && mri_vol2vol --mov ./${hemi}.polarAngle${minDegree[$DEG]}to${maxDegree[$DEG]}.nii.gz --targ ${input_nii_gz} --regheader --o ./${hemi}.polarAngle${minDegree[$DEG]}to${maxDegree[$DEG]}.nii.gz --nearest
	done
done